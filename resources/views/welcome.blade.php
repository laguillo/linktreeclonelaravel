        ...
        <div class="">
            ...
            <div class="bg-mirage-500 mx-auto my-20 h-auto max-w-sm overflow-hidden rounded-sm shadow-lg">
                <img class="mx-auto mt-8 h-48 w-48 rounded-full border-4 border-white object-cover p-1"
                    src="{{ $avatar ?? 'https://i.blogs.es/ceda9c/dalle/1366_2000.jpg' }}" alt="El Rincon de Isma" />
                <div class="px-6 py-4 text-white">
                    <div class="flex flex-col">
                        <a href="{{ $seo->url }}" target="_blank" rel="noopener noreferrer"><div class="text-center text-xl font-bold hover:cursor-pointer">{{ $bio->title }}</div></a>
